...
abstract final class AppTheme {
  static ThemeData light = FlexThemeData.light(
      colors: const FlexSchemeColor(
          ...
          secondaryContainer: AppColors.purple500,
          tertiary: AppColors.green100,
          tertiaryContainer: AppColors.background,
          appBarColor: AppColors.purple500,
      ...
      subThemesData: const FlexSubThemesData(
          ...
          cardBackgroundSchemeColor: SchemeColor.onInverseSurface,
          cardElevation: 2.0,
          alignedDropdown: true,
          dialogBackgroundSchemeColor: SchemeColor.secondaryFixed,
